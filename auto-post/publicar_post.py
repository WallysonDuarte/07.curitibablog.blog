...
def main(json_path: str):
    ...
    try:
        ...
        try:
            ...
            # 5. Upload IDrive E2 — SEMPRE a imagem QUADRADA original (blog + Instagram + og:image)
            # NOTA: converter_fb nao deve ser aplicado aqui — IDrive guarda a versao quadrada
